...
save = input("Would you save .heic files? y/n: ")

target_extension = input("Write the target extention: ")

target_extension_save = target_extension


if target_extension == "jpg":
    target_extension_save = "JPEG"
...
def convert_heic_to_jpeg(dir_of_interest, save):
    ...
    for root, filename in heic_files:
        ...
        if image_exif:
            ...
            # Save image as jpeg
            image.save(target_file, target_extension_save, exif = exif_bytes)
...
if __name__ == '__main__':
    ...
    converted = convert_heic_to_jpeg(path, save)
